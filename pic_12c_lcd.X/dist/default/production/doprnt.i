...
# 1055 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
...

{
 ...
 _Bool p = 1;
# 1082 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
    w = width;
# 1095 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
    i = sizeof(dbuf) - 1;
    dbuf[i] = '\0';
    while (!(i < 2) && (d != 0
...
# 1152 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
        ...
        while (!done) {
            switch ((*fmt)[0]) {
                ...
                case '0' :
                    ...
                    ++*fmt;
                    break;
# 1242 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
                default:
                    done = 1;
                    break;
            }
        }
# 1256 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
...
# 1291 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
  cp = *fmt;
# 1439 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
  if (0

    || *cp == 'x'
# 1452 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
    ) {
# 1495 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
   convarg.uint = (vfpf_uint_t)(unsigned int)(*(unsigned int *)__va_arg(*(unsigned int **)ap, (unsigned int)0));

   *fmt = cp+1;
   switch (*cp) {
# 1550 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
    case 'x':
# 1586 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
